...
I'm a **Computer Science student** passionate about **cybersecurity**, building security tools, and breaking (then fixing) things. I learn by doing — my repos are a mix of security projects, full-stack apps, and automation experiments.

```bash
$ whoami
> Security Researcher | CTF Player | Code Breaker & Builder
```
